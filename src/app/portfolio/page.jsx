...
const items = [
  ...
  },
  {
    ...
    title: "Github",
    desc: "Explore my GitHub repository to discover: Innovative Projects: Creative solutions showcasing my problem-solving skills. Diverse Technologies: Proficiency in various languages, frameworks, and tools. Collaborative Work: Team projects illustrating my teamwork abilities. Continuous Learning: Commitment to staying current with industry trends. Visit my GitHub to see projects that highlight my technical expertise and passion for software development.",
    img: "/githubb.png",
